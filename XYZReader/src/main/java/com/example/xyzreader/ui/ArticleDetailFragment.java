...
public class ArticleDetailFragment extends Fragment implements
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == SHARE_REQ_CODE && resultCode == Activity.RESULT_OK) {
            Spanned content = Html.fromHtml("<font color=\"#ffffff\">" + getString(R.string.shared_success) + "</font>");
            Snackbar.make(mRootView, content, Snackbar.LENGTH_LONG).show();
            return;
        }
        if (requestCode == SHARE_REQ_CODE) {
            Spanned content = Html.fromHtml("<font color=\"#ffffff\">" + getString(R.string.shared_error) + "</font>");
            Snackbar.make(mRootView, content, Snackbar.LENGTH_LONG).show();
            return;
        }
